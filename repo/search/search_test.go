...
func (s *SearchSuite) TestTermToCond(c *C) {
	...
	c.Assert(tc(TermSource("abcd")), Equals, "(rpm_sourcerpm = \"abcd\" OR location_href = \"abcd\")")
	c.Assert(tc(TermSource("abcd", TERM_MOD_NEGATIVE)), Equals, "(rpm_sourcerpm != \"abcd\" OR location_href != \"abcd\")")
